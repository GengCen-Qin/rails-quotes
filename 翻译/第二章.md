...
![img](https://img-blog.csdnimg.cn/img_convert/f5e0db42b50a65d111b4945dcbde67cf.png)

当点击`New quote`按钮时跳转到`Quotes#new`页面：

![img](https://img-blog.csdnimg.cn/img_convert/a018ec6ac774ee170e281b7a9831753f.png)

当点击`Create quote`时跳转到`Quotes#index`页面，显示存储的数据，并按照时间排序。

当你点击Edit按钮时，就会跳转到`Quotes#edit`去更新已有的数据

![img](https://img-blog.csdnimg.cn/img_convert/67727a53b31b963137eb309625003827.png)

当点击`Update quote`，还是跳回`Quotes#index`页面

当点击quote的标题时，则跳转到`Quotes#show`，现在我们仅仅显示标题，后面增加其他内容。

![img](https://img-blog.csdnimg.cn/img_convert/ff89835e6e40860a36acd80a8015223c.png)
