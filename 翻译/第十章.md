...
![image-20230629212417936](/Users/qinsicheng/Library/Application%20Support/typora-user-images/image-20230629212417936.png)
...
![image-20230629213542656](/Users/qinsicheng/Library/Application%20Support/typora-user-images/image-20230629213542656.png)

这样当用户点击"New item"按钮时，Turbo将成功用表单替换掉空Turbo Frames

![image-20230629213715380](/Users/qinsicheng/Library/Application%20Support/typora-user-images/image-20230629213715380.png)

当用户提交表单时，我们想让创建的line item被添加到特定日期下的line items列表中。

![image-20230629213825492](/Users/qinsicheng/Library/Application%20Support/typora-user-images/image-20230629213825492.png)
...
不同于直接依赖`dom_id helper`，我们创建一个helper去让我们的ids更容易生成或阅读，
